...
<form class="form-horizontal" id="bizForm" method="post" action="/${cmpName}/">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="statDate" name="statDate" value="${entity.statDate}" readonly/>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="appName">代码</label>
		<div class="controls">
			<input type="text"  id="appName"  value="${app.name}" readonly/>
		</div>
	</div>	
	<div class="control-group">
		<label class="control-label" for="channelId">渠道号</label>
		<div class="controls">
			<input type="text" id="channelId"  name="channelId" value="${entity.channelId}" readonly/>
		</div>
	</div>		
	<div class="control-group">
